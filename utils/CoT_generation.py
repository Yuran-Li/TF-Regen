...
from .check import check_answer_gsm_hard, check_answer_strategyqa, check_answer_gsm8k, check_answer_math,check_answer_coin, check_answer_letter, check_answer_legal, check_answer_bamboogle, check_answer_Headline, extract_answer
...
DATASET_CONFIG = {
    "gsm8k": {
        ...
        "fixed_template": "contrastive_cot_gsm8k_prompt",
        "template_verify": "./verify/algorithmic_contrastive_guided_assessment_prompt(reflect)",
    ...
    "gsm_hard": {
        ...
        "template": "few_shot_CoT_generation_gsm8k_prompt",
        "zero_shot_template": "./zero_shot/CoT_generation_gsm8k_prompt",
        "fixed_template": "contrastive_cot_gsm_hard_prompt",
        "template_verify": "./verify/algorithmic_contrastive_guided_assessment_prompt(reflect)",
    ...
    "math": {
        ...
        "template": "few_shot_CoT_generation_gsm8k_prompt",
        "zero_shot_template": "./zero_shot/CoT_generation_gsm8k_prompt",
        "fixed_template": "contrastive_cot_math_prompt",
        "template_verify": "./verify/algorithmic_contrastive_guided_assessment_prompt(reflect)",
    ...
    "strategyQA": {
        ...
        "fixed_template": "contrastive_cot_strategyQA_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
        "check_func": check_answer_strategyqa,
        "answer_field": "answer"
    },
    "bamboogle": {
        "question_field": "Question",
        "template": "few_shot_CoT_generation_bamboogle_prompt", 
        "zero_shot_template": "./zero_shot/CoT_generation_bamboogle_prompt",
        "fixed_template": "contrastive_cot_bamboogle_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
        "check_func": check_answer_bamboogle,
        "answer_field": "Answer"
    },
    "coin": {
        ...
        "fixed_template": "contrastive_cot_coin_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
    ...
    "letter": {
        ...
        "fixed_template": "contrastive_cot_letter_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
    ...
    "legal": {
        ...
        "fixed_template": "contrastive_cot_legal_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
    ...
    "Headline": {
        "question_field": "News",
        "template": "few_shot_CoT_generation_Headline_prompt",
        "zero_shot_template": "./zero_shot/CoT_generation_Headline_prompt",
        "fixed_template": "contrastive_cot_Headline_prompt",
        "template_verify": "./verify/reasoning_contrastive_guided_assessment_prompt(reflect)",
        "check_func": check_answer_Headline,
        "answer_field": "Price Sentiment"
    }
    }
...
class CoTGeneration:
    def __init__(self, model_name, model_type, dataset_name, method, eg_path, temperature=0, top_p=1.0, max_tokens=1024, seed=42):
        ...
        if self.method == "similarity" and self.eg_data is not None:
            ...
            self.good_items = self.good_items[:150]
            self.error_items = self.error_items[:150]
    ...
    def generate_cot_contrastive(self, data):
        ...
        # selected_items = [self.good_items[1]] + [self.good_items[2]] + [self.error_items[1]] + [self.error_items[2]]
        config = DATASET_CONFIG.get(self.dataset_name)
        if not config:
            raise ValueError(f"Unsupported dataset: {self.dataset_name}")
    ...
    def one_stage_prompt(self, data, selected_items, config):
        ...
        prompt = prompts.render_template(
            "few_shot_CoT_generation_prompt(rectify)", 
            question=data[config["question_field"]], 
            prediction=data["CoT"],
            examples=examples
        )
    ...
    async def two_stage_prompt(self, data, selected_items, config):
        ...
        reflection_prompt = prompts.render_template(
            "few_shot_CoT_generation_prompt(rectify-stage1)", 
            question=data[config["question_field"]], 
        ...
        reasoning_prompt = prompts.render_template(config["zero_shot_template"], question=data[config["question_field"]])
        previous_attempt_text = f"Unsuccessful Attempt: {prediction}\n\n"
        reflection_text = f"Reflection: {reflection_output}"
        rectify_prompt = f"{reasoning_prompt}\n\n{previous_attempt_text}{reflection_text}"
